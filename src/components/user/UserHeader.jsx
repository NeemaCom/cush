...
const UserHeader = () => {
  return (
    <nav className=" bg-[url('/Userheader.png')] bg-center bg-cover w-[100%]  py-9 border-b border-gray-200 px-4">
      <div className=' ml-[15%] pl-10 pr-10 bg-white py-2 rounded-l-lg'>
